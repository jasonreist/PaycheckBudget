...
namespace PB.UI.DAL
{
    public class PBIinitializer : System.Data.Entity.CreateDatabaseIfNotExists<PBContext>
    {
        ...
        protected override void Seed(PBContext context)
        {
            ...
            //ApplicationSignInManager SigninManager = System.Web.HttpContext.Current.GetOwinContext().Get<ApplicationSignInManager>();
            //var user = new ApplicationUser { UserName = "demo1", Email = "demo1@demo.com", FirstName = "Demo", EmailConfirmed = true };
            ...
            //context.Settings.Add(new Setting() { UserID = newuserid, AddTithe = true, TitheMultiplier=.1291m, TitheBGColor="000000", TitheForeColor="ffffff", ChecksToShow=4, DaysInPeriod=14, PreviousPeriodsToShow=1, WeekStartDay=0 });
            //context.Paydays.Add(new Payday() { UserId = newuserid, Paydate = new DateTime(DateTime.Now.Year, DateTime.Now.Month, 1) });
            ...
            //{
            //    new Bill{UserId=newuserid, Name="Mortgage/Rent", Amount=1542.24m, DueDay=1, ForeColor="ff00ff", BackgroundColor="000000"},
